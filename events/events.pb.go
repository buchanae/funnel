...
func (*GetEventsRequest) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{6} }

func (m *GetEventsRequest) GetId() string {
	if m != nil {
		return m.Id
	}
	return ""
...
func (*GetEventsResponse) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{7} }
...
func init() {
	...
	proto.RegisterType((*GetEventsRequest)(nil), "events.GetEventsRequest")
	proto.RegisterType((*GetEventsResponse)(nil), "events.GetEventsResponse")
...
func (c *eventServiceClient) GetEvents(ctx context.Context, in *GetEventsRequest, opts ...grpc.CallOption) (*GetEventsResponse, error) {
	...
	err := grpc.Invoke(ctx, "/events.EventService/GetEvents", in, out, c.cc, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _EventService_GetEvents_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/events.EventService/GetEvents",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
var fileDescriptor0 = []byte{
	...
	,
}
