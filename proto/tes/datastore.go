...
func (t *Task) Save() ([]datastore.Property, error) {
  ...
  //props = append(props, saveMap(t.Tags, "Tags"))
  return props, nil
}
...
func (e *Executor) Save() ([]datastore.Property, error) {
  ...
  //props = append(props, saveMap(e.Environ, "Environ"))
  return props, nil
}
...
func (t *TaskLog) Save() ([]datastore.Property, error) {
  props, _ := datastore.SaveStruct(t)
  //props = append(props, saveMap(t.Metadata, "Metadata"))
  return props, nil
}
...
func (p *Ports) Load(ps []datastore.Property) error {
  for _, prop := range ps {
    switch prop.Name {
    case "Container":
      p.Container = prop.Value.(uint32)
    case "Host":
      p.Host = prop.Value.(uint32)
    }
  }
  return nil
}
